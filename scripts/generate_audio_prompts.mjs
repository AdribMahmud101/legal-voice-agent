...
async function main() {
  ...
  const prompts = [
    ...
    },
    {
      ...
      text: "প্রথমে আপনার ভাষা নির্বাচন করুন: বাংলার জন্য ১, মারমার জন্য ২, চাকমার জন্য ৩ চাপুন, অথবা মুখে ভাষার নাম বলুন। এরপর সাধারণ তথ্যের জন্য ১, সমস্যা বা অভিযোগের জন্য ২ এবং কেস ট্র্যাকিংয়ের জন্য ৩ চাপুন।"
    },
    {
      name: "language_confirmed_bn.wav",
      text: "বাংলা ভাষা নির্বাচিত হয়েছে। এখন সাধারণ তথ্যের জন্য ১, সমস্যা বা অভিযোগের জন্য ২ এবং কেস ট্র্যাকিংয়ের জন্য ৩ চাপুন।"
    },
    {
      name: "language_confirmed_marma.wav",
      text: "মারমা ভাষা নির্বাচিত হয়েছে। এখন সাধারণ তথ্যের জন্য ১, সমস্যা বা অভিযোগের জন্য ২ এবং কেস ট্র্যাকিংয়ের জন্য ৩ চাপুন।"
    },
    {
      name: "ivr_menu.wav",
    ...
    },
    {
      ...
      text: "চাকমা ভাষা নির্বাচিত হয়েছে। এখন সাধারণ তথ্যের জন্য ১, সমস্যা বা অভিযোগের জন্য ২ এবং কেস ট্র্যাকিংয়ের জন্য ৩ চাপুন।"
    }
  ];
